% server loc'n of filename. This is windows based, sry
...
% try to automatically update the date for Saturday
satDate = today+(7-weekday(datestr(today))); % Add the difference between today's date and saturday to get Sat's datenum
satStr = datestr(satDate,'yyyy-mm-dd'); % datestr from datenum
